...
edX.setPset(1,100)
print edX.myCourses[0].getPset(1)
print

edX.setPset(2,100,"6.00x")
edX.setPset(2,90,"6.00x")
print edX.myCourses[0].getPset(2)
print edX.myCourses[0].getPset(2)
print
...
print
print 'Courses Highest Grades'
print edX.myCourses[0].courseName + ': ' + str(edX.myCourses[0].getGrade())
print edX.myCourses[1].courseName + ': ' + str(edX.myCourses[1].getGrade())
print edX.myCourses[2].courseName + ': ' + str(edX.myCourses[2].getGrade())
